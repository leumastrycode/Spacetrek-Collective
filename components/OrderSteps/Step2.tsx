...
export default function Step2({ onNext }: Step2Props) {
  ...
  const options = [
    {
      label: "Technology / IT / Software Development",
      value: "Technology / IT / Software Development",
    },
    { label: "Crypto / Web3 / FinTech", value: "Crypto / Web3 / FinTech" },
    { label: "Gaming / Digital Entertainment", value: "Gaming / Digital Entertainment" },
    { label: "Fashion / Modern Lifestyle", value: "Fashion / Modern Lifestyle" },
    { label: "Food & Beverage / Culinary", value: "Food & Beverage / Culinary" },
  ];
      ...
      <div className="glass-effect justify-center text-black rounded-[10px] max-w-[600px] md:max-w-[1400px] w-full shadow-2xl relative p-6 sm:p-10 md:p-[90px]">
        ...
        <div className="flex flex-row items-center gap-3 sm:gap-5 self-stretch h-5 mt-[80px]">
          <div className="w-full md:max-w-[360px] h-4 bg-indigo-600/20 border-white border-[1px] rounded-[0]">
            <div className="w-[40%] h-full bg-indigo-700 rounded-[0]" />
          </div>
